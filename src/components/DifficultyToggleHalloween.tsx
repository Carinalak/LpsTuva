...
import { BLEKASTPUMPA, FONT_PLAYPEN, KOLSVART, KRITVIT, PUMPAORANGE } from "./styled/Variables";

interface DifficultyToggleHalloweenProps {
  onClick: () => void;
...
export const DifficultyToggleHalloween: React.FC<DifficultyToggleHalloweenProps> = ({ onClick, difficulty }) => {
  return (<ToggleWrap>
