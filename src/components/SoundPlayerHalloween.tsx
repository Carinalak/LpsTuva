...
export interface SoundPlayerHalloweenHandle {
  play: (soundType: "flip" | "match" | "win") => void;
}

interface SoundPlayerHalloweenProps {
  winVolume?: number;
  flipVolume?: number; 
  matchVolume?: number;
}

export const SoundPlayerHalloween = forwardRef<SoundPlayerHalloweenHandle, SoundPlayerHalloweenProps>(({
  winVolume = 1.0,
  flipVolume = 1.0,
  matchVolume = 1.0
}, ref) => {
